...
int main(int argc, char const *argv[])
{
    ...
    for (i = 0; i < NUMBER_OF_COMMANDS; i++)
    {
        ...
        printf("%s \t", comList[i].name);
        printf("%d \t", comList[i].funct);
        printf("%d \t", comList[i].opcode);
        printf("\n");
    }
    
    if (ONE_OR_THREE == (us_binary_to_int("0010"))|(us_binary_to_int("1000")))
    {
        printf("OK1");
    }
    if (ZERO_OR_ONE_OR_THREE == (us_binary_to_int("0010"))|(us_binary_to_int("1000"))|(us_binary_to_int("0001")))
    {
        printf("OK2");
    }
    if (NONE == (us_binary_to_int("0000")))
    {
        printf("OK3");
    }
    if (ONE_OR_TWO == (us_binary_to_int("0010"))|(us_binary_to_int("0100")))
    {
        printf("OK4");
    }
