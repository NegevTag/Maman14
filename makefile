prog: commandHandler.o commndList.o commndWordList.o labelParamList.o instructionHandler.o entryList.o instructionWordsList.o labelHandler.o assembler.o utilities.o main.o
